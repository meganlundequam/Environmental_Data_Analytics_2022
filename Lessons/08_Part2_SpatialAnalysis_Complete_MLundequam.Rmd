...
epa_pm25_sites_sf <- read_csv('./Data/Raw/EPAair_PM25_NC2018_raw.csv') %>% 
  ...
  st_as_sf(coords = c('SITE_LONGITUDE','SITE_LATITUDE'), crs=4269) #turns into sf object and specifies x and y
...
# this creates a spatial bounding box around the features - tells the spatial extents of the objects
st_bbox(counties_sf)
