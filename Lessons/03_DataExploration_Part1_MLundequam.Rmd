...
> Answer: Out put shows! Shows all the packages coming with what youve installed.
...
> ANSWER: Found in metadata folder. Helps to explain data so the data and subsequent analyses can be used by others!
